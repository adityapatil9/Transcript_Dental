...
<form class="form-horizontal"id="form1" name="check_docs" method="POST" width="50%" action="send_email.php">
<div class="form-group">
	<center><h3><strong>SEND TRANSCRIPT</strong></h3></center><br><br>
...
$sql ="SELECT * FROM current_status WHERE status=3";
$res =mysql_query($sql);
