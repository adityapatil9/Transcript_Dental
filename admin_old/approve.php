...
else
{
	...
	echo "MARKS ENTERED FOR ".$count_student_total.' SEMESTERS';
	...
	echo "<br>ENTRIES RECORDED FOR FOLLOWING SEMESTERS : ";
	...
	//PRINT BUTTON
	?>
	<center> <input type="button" class="button" value="Approve Uploaded Transcripts"  onClick="parent.location='uploaded_unverified_files.php'" ></input></center>
	<br>
	<center> <input type="button" class="button" value="Print Approved Transcripts" onclick="printPage('ts_summary');"></input></center>
    <br>
    <center> <input type="button" class="button" value="EMAIL Approved Transcripts" onclick="window.open('send_email.php')"></input></center>
