      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="index.php"><i class="fa fa-home"></i> <span>View Requests</span></a></li>
           <li><a href="verify_details.php"><i class="fa fa-home"></i> <span>Verify Documents</span></a></li>
